...
export function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full p-8 relative overflow-hidden bg-[#050505] text-white selection:bg-[#FFD700]/30">
      ...
      <img src="/src/assets/images/cm_logo_ultra_realistic_1785123978899.jpg" alt="CM Network Logo" className="w-24 h-24 mb-8 rounded-full drop-shadow-[0_0_20px_rgba(255,215,0,0.4)] animate-bounce relative z-10" />
